...
public class Educational_Volunteering extends AppCompatActivity {
    private int mcount = 0;
    ListView llistview;
    ArrayList<Advertis> lists;
    AdapterEducational adapter = null;
    ...
    public void showupdatedialog(Activity activity, final int position) {
        ...
        imagevicon.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ActivityCompat.requestPermissions(
                        Educational_Volunteering.this, new String[]
        ...
        updatess.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Educational_Volunteering.mSqlitehelper.updateData(
                    ...
                    dialog.dismiss();
                    Toast.makeText( Educational_Volunteering.this,"Update Successfull",Toast.LENGTH_SHORT ).show();
                }
    ...
    private void showdeletdialog(final int idrecord) {
        ...
        AlertDialog.Builder deletedialog = new AlertDialog.Builder( Educational_Volunteering.this );
        ...
        deletedialog.setPositiveButton( " OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                try {
                    ...
                    Toast.makeText(Educational_Volunteering.this,"Deleted successfully",Toast.LENGTH_SHORT ).show();
                }catch (Exception e){
    ...
    private void updateRecordList() {
        ...
        Cursor cursor = Educational_Volunteering.mSqlitehelper.getData(  "SELECT * FROM RECORD");
        lists.clear();
        while (cursor.moveToNext()) {
            int id = cursor.getInt( 0 );
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_educational__volunteering);
        ...
        llistview = findViewById(R.id.listaeducation);
        vieww = findViewById(R.id.imgiicon);
        count = findViewById(R.id.counts);
        lists = new ArrayList<Advertis>();
        adapter = new AdapterEducational(this, R.layout.row_edu, lists);
        ...
        Cursor cursor = Educational_Volunteering.mSqlitehelper.getData(" SELECT * FROM RECORD WHERE category = 3");
        lists.clear();
        while (cursor.moveToNext()) {
            int id = cursor.getInt(0);
            String ti = cursor.getString(1);
        ...
        llistview.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, final int position, long l) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(Educational_Volunteering.this);
                ...
                dialog.setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        if (i == 0) {
                            ...
                            //show dialog update
                            showupdatedialog(Educational_Volunteering.this, attID.get(position));
                        }
                        if (i == 1) {
                            //delete
    ...
    public void Viewedu(View view) {
        Intent rec = new Intent( Educational_Volunteering.this,Views.class );
        startActivity( rec );
    }
    public void Acceptedu(View view) {

        Intent acc = new Intent( Educational_Volunteering.this, Acceptable.class );
        startActivity( acc );

    }
    public void participatedu(View view) {

        Intent parts = new Intent( Educational_Volunteering.this, Participate.class );
        startActivity( parts );
    }

    public void Recomendededu(View view) {

        Intent rec = new Intent( Educational_Volunteering.this, Recomended.class );
        startActivity( rec );
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.msg) {
            Intent messaage = new Intent(Educational_Volunteering.this, Messages.class);
            startActivity(messaage);
        }
        if (id == R.id.homee) {
            Intent hpp = new Intent(Educational_Volunteering.this, Voulnteers.class);
            startActivity(hpp);
        }
        if (id == R.id.options) {
            Toast.makeText(Educational_Volunteering.this, "choose Option", Toast.LENGTH_SHORT).show();
        }
        if (id == R.id.edits) {
            Intent edit = new Intent(Educational_Volunteering.this, SampleActivity.class);
            startActivity(edit);
        }
        if (id == R.id.hs) {
            Intent help = new Intent(Educational_Volunteering.this, Help_Support.class);
            startActivity(help);
        }
        if (id == R.id.lo) {
            Intent loog = new Intent(Educational_Volunteering.this, Welcome.class);
            startActivity(loog);
        }
        return true;
    }
